...
| 2 | serve | PASS | cd "$DATA" && exec "$SRC/.venv/bin/archivebox" server 127.0.0.1:$PORT → http://127.0.0.1:44239 |
| 3 | proxy | PASS | http://127.0.0.1:34215 → http://127.0.0.1:44239 |
