...
| 1 | build | PASS | 6 step(s), 106s |
| 2 | serve | PASS | cd "$DATA/host" && exec php artisan serve --host=127.0.0.1 --port=$PORT → http://127.0.0.1:43629 |
| 3 | proxy | PASS | http://127.0.0.1:36423 → http://127.0.0.1:43629 |
