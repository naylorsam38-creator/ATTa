...
| 2 | serve | PASS | cd "$DATA" && exec "$SRC/.venv/bin/archivebox" server 127.0.0.1:$PORT → http://127.0.0.1:38489 |
| 3 | proxy | PASS | http://127.0.0.1:41961 → http://127.0.0.1:38489 |
