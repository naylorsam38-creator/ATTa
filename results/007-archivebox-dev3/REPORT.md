# 007-archivebox-dev3 — FAIL

Run: 2026-09-23T04:11:22.709Z

> ArchiveBox dev3 re-pack (same app as 002; out/ bundle now inside the app folder, archivebox/static is a real directory). ArchiveBox (Python/Django, served by daphne). Fresh collection initialised in data/; unauthenticated visit lands on the admin login screen.
...
| 1 | build | PASS | 2 step(s), 7s |
| 2 | serve | PASS | cd "$DATA" && exec "$SRC/.venv/bin/archivebox" server 127.0.0.1:$PORT → http://127.0.0.1:37535 |
| 3 | proxy | PASS | http://127.0.0.1:32807 → http://127.0.0.1:37535 |
