...
| 1 | build | PASS | 2 step(s), 69s |
| 2 | serve | PASS | cd frontend && NODE_ENV=production exec node .output/server/index.mjs → http://127.0.0.1:33899 |
| 3 | proxy | PASS | http://127.0.0.1:34055 → http://127.0.0.1:33899 |
...
| C6 | Drag-move a link | PASS | <a> "Get Started" (display:block): mover recorded translate="120px 60px" (saved=true); on screen it moved 120,57px, visible and clickable at the new spot |
| C7 | Drag-move a button | PASS | <button> "01 Capture Ideas Instantly Quick notes &" (display:flex): mover recorded translate="120px 60px" (saved=true); on screen it moved 124,50px, visible and clickable at the new spot |
