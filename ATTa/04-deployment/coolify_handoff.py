...
def resource_for(app: str) -> dict | None:
    """v117 (from PR #3): the Coolify resource for an app. coolify_resources.json maps an app to a UUID string (an
    application) or {"uuid": "...", "kind": "application" | "service"}. None if unmapped or malformed."""
